...
public class TykUtil {

    public static CreateDeploymentParam deploy(CreateTykReq req) {
        CreateDeploymentParam param = new CreateDeploymentParam();
        param.setDeploymentName(KubernetesUtil.name("tyk", req.getName()));
    ...
    public static CreateServiceParam service(CreateTykReq req) {
        CreateServiceParam createServiceParam = new CreateServiceParam();
        createServiceParam.setServiceName(KubernetesUtil.name("tyk", req.getName()));
